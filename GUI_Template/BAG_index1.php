    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">BAG Risk Assessment System</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <p>
                               ...
                               NASA Inner System of Spacecraft Department
                               </button>
                            </p>
                            <?php
	function number(){
		$mysqli =new mysqli("localhost:3306", "root", "930911", "web_ui"); //实例化
		$result=mysqli_query($mysqli, 'select id from test');
		$num=mysqli_num_rows($result);                            //取得包含id字段记录的行数
		return $num;
		}
   	$txt1='<a href="index.html" style="text-decoration:none" ><p><button type="button" class="btn btn-outline btn-danger btn-lg btn-block">';
    	$txt3 ='</button></p></a>';
		
	//for($times = 1 ; $times <= number() ; $times++)
	//{
		$mysqli =new mysqli("localhost:3306", "root", "930911", "web_ui");
		$result=mysqli_query($mysqli,"select * from red");
		while($row=mysqli_fetch_array($result))
		{
		echo $txt1 . 'warn1：'.$row['warn1'] . $txt3;
		}
	//}
       ...
       // mysqli_free_result($result); 
                             ...
                             <a href="index.html" style="text-decoration:none" ><p>
